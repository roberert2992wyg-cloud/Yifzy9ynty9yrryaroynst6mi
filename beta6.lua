...
local function buildHub(langCode)
    ...
    spawn(function()
        while true do
            wait(1)
            HoraParagraph:SetText(getBrasiliaTime())
        end
    end)
    ...
    spawn(function()
        while true do
            wait(1)
            ExecuteTimeParagraph:SetText(getExecuteTime())
        end
    end)
    ...
    local function refreshPlayerList()
        ...
        if playerDropdown then
            ...
            playerDropdown:SetDefault(selectedPlayer or players[1] or lang.teleport_no_players)
        end
    end
    ...
    local function pickupItem(itemName)
        local hammer = workspace:FindFirstChild("Hammer")
        ...
        hrp.CFrame = CFrame.new(hammer.Position + Vector3.new(0, 1, 0))
